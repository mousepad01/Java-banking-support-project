...
public class Client extends Person {
    ...
    public Client(String name, String surname, String birthDateStr, String address, String email, String phoneNumber, String registrationDateStr) {
    ...
    public Client(String name, String surname, String birthDateStr, String registrationDateStr) {
